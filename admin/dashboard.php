              ...
              <div class="list-group">
                    ...
                    <a href="javascript:void(0):#itinerary5" class="list-group-item list-group-item" data-toggle="collapse" data-parent="#MainMenu"><span class='glyphicon glyphicon-tasks' style='padding-right:15px;' aria-hidden='true'></span>Itineraries<span class="caret" style='position:absolute;top:17px;right:30px;'></span></a>
                            <div class="collapse" id="itinerary5">
                              ...
                              <a href="#/itsalecancelled" class="list-group-item list-group-item" style='padding-left:30px;'>Sale Cancelled</a> 
...
<!-- Button trigger modal -->
            ...
            <div class="modal fade" id="deleteitModal2" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
          <div class="modal-dialog" role="documnent">
            <div class="modal-content">
              <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                  <span aria-hidden="true">×</span></button>
                <h4 class="modal-title" id="myModalLabel">Sales Manager Name</h4>
              </div>
              <div class="modal-body">
                <p >Please Provide the Sales Manager Name</p>
                <div class="form-group">
                  <label for="deletereason"><b>Remark:</b></label><br>
                  <textarea name="deletereason" id="deletereason" placeholder="Enter Sales Manager Name" cols="50" rows="6" autofocus required></textarea>
                </div>
              ...
              <div class="modal-footer">
                ...
                <button type="button" id="submitReason" class="btn btn-warning pull-left" onClick="#">Submit</button>
                      ...
                      while($row = $res->fetch_assoc()) 
                          {
                              ...
                              if($remarksubmitted == "submitted"){
                                ...
                                $button = "<button type='button' name='deleteit' id='deleteit' class='btn btn-danger btn-sm' data-toggle='modal' data-target='#deleteitModal' role='button' onclick='passRefValue(".$row["ref_num"].");'>View Remark</button>";
                              }
                              ...
                              echo " <tr style='background-color: $color;'>
                                  ...
                                  <td>".$row["remarks"]."</td>
                                   ...
                                   <td><a class='btn btn-danger btn-sm' href='rejectdsr.php?q=".$row["ref_num"]."'>Reject</button></td>
                                  
                                  <td><button type='button' name='deleteit' id='deleteit' class='btn btn-success btn-sm' data-toggle='modal' data-target='#deleteitModal2' role='button' onclick='passRefValue2(".$row["ref_num"].");'>Accept</button></td>
                                  ";
...
<script type="text/ng-template" id="pages/itsalecancelled.php"> 
...
<br>
                     ...
                     <?php
                      ...
                      {
                        $sql1= "SELECT * FROM agent_form_data INNER JOIN login
                                WHERE agent_form_data.currently_worked_by = login.userid and  (formstatus != 'pending' and formstatus!= 'smashed') and remarkstatus = 'rejected'

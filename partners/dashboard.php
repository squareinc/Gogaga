    ...
    <section class="content container-fluid">
      ...
      <!--
       ...
       -->
        ...
        <div class="col-md-3 col-sm-6 col-xs-12">
          <div class="info-box">
            <span class="info-box-icon bg-red"><i class="ion ion-email-unread"></i></span>
            ...
            <div class="info-box-content">
              ...
              ?>
              <span class="info-box-number"><?php if(isset($total_itineraries_quoted)){ echo $total_itineraries_quoted; } ?></span>
            </div>
            <!-- /.info-box-content -->
          </div>
          <!-- /.info-box -->
...
*/
              ...
              <span class="info-box-number"><?php if(isset($total_itineraries_converted) != ""){ echo $total_itineraries_converted; } ?></span>
            </div>
            <!-- /.info-box-content -->
          </div>
          <!-- /.info-box -->
          ...
          <div class="info-box">
            ...
            <div class="info-box-content">
              ...
              */
              ...
              <span class="info-box-number"><?php if(isset($total_volume_converted)){ echo $total_volume_converted; } ?></span>
            </div>
            <!-- /.info-box-content -->
          </div>
          <!-- /.info-box -->

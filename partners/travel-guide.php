...
?>
   ...
   <script>
    $("#sidebar-travel-guide").addClass("active");
  </script>
          ...
          <div class="box">
            ...
            <div class="box-body table-responsive no-padding">
              <table class="table table-hover">
                <tbody>
                  <iframe src="https://docs.google.com/document/d/e/2PACX-1vSB151i8ZTeE7ySzIxSZ-Pmd_ZQlAzYsH09FlojZv6fnasMk4ZaJOtsygyYHYpzy4jojmVkYwGJkUlW/pub?embedded=true" width="1024" height="1024"></iframe>

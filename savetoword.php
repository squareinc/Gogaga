...
<div class='content'>
	<table class='table table-responsive' style='border:none;background-color: white;'>
               ...
               <tr>
                    ...
                    <td style='width:300px;'><?php echo strtoupper($emp_name)." ( Ph.no :   ".$emp_contact ." )";?>
                    </td>
               </tr>
...
<div class='bot_travel'>
	We thank you for giving us an opportunity to be your holiday service provider. We are commited to make your holiday fun filled with a hassle free experience. Below is your Itinerary.
  <br>
...
".top_part{position:absolute;top:5px;left:40px;width:70%}"+
".logo{position:absolute;right:10px;top:0}"+
".top_heading{position:absolute;top:-20px;left:20px;width:300px}"+
".content{position:absolute;top:470px;left:50px;font-family:'Source Sans Pro',sans-serif}"+
"tr{height:40px}"+
".table1{position:absolute;left:100px}"+
".top_section{position:absolute;top:60px;float:left}"+
".bot_travel{position:absolute;top:900px;left:50px;padding-right:100px;height:100px;width:100%}"+
".holipic{position:absolute;top:20px;right:10px}"+
".second_page{position:absolute;top:1000px;width:100%}"+
".itday{float:left;height:30px;padding-left:10px;width:50px}"+
".ithead{float:left;height:30px;padding-left:10px;width:250px}"+
".ithotel{float:left;height:30px;padding-left:10px;width:250px}"+
".itmeal{float:left;height:30px;padding-left:10px;width:150px}"+
".itdate{float:left;height:30px;padding-left:10px;width:150px}";

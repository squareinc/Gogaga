        ...
        if(isset($_POST['location'])){
              $cntt=1;
                    ...
                    foreach ( $_POST['location'] as $key=>$location) {
                        ...
                        if(!empty($location) || !empty($checkindate) || !empty($checkoutdate) || !empty($vendor) || !empty($hotelstnd) || !empty($roomstnd))
                        {  
    ...
    if($ref_type =="Domestic")
    {
        if($baggagecost!=""){
          ...
          $sql="UPDATE  itinerary_domestic  SET  supname = '".$a1."', supperc = '".$a2."',
               ...
               no_of_pax='".$no_of_pax."',totcost = '".$z."',totcostfl ='".$zflp."',roomtype = '".$roomtype."'          
         ...
         if($baggagecost!=""){
          $zflp = $zflp + $baggagecost;
            ...
            $sql="UPDATE  itinerary_inter  SET  currency_amount =  '".$cur_amt."',
                 ...
                 transp_vehicle_type =  '".$e4."',transp_vendor_details =  '".$e5."', transp_vehicle =  '".$e3."', transp_amt =  '".$e1."', remit =  '".$f."',
       ...
       $sql = "DELETE FROM flights_info WHERE ghrno = '".$ref_value."'";
           ...
           foreach ( $_POST['airline'] as $key=>$airline) {
                        ...
                        {  
                            ...
                            $sql = "INSERT INTO flights_info (ghrno,sno,airline,airport,arrdep,airdur,airdates,airtrav,airprice,flighttype,baggageweight,baggageprice) 
                                    VALUES ('$ref_value',$sno,'$airline','$airport','$arrdep','$airdur','$airdates','$airtrav','$airprice','$flighttype','$baggageweight','$baggageprice')";
                                if(($conn->query($sql))== true)
                                {                       
...
$(function(){
 ...
 $('#container').append('<tr style="font-size:11px;">'
                               ...
                               +'<td><input type="text" name="hotelstnd[]"size="10"></td>'
 ...
 $('#contair').append('<tr style="font-size:11px;">>'
                              ...
                              +'<td><input class="pull-right" style="background: #fff; cursor: pointer;   width: 100%; margin-bottom: 10px;" type="text" name="airdates[]" size="15"></td>'
                                +'<td><input type="text" name="airtrav[]" size="3"></td>'
...
<div class="row">
  <div class="col-md-2 col-md-offset-5">
    <button type="button" class="btn btn-danger btn-block">Page 2</button><br>
  </div>
</div>
                   ...
                   {      $mealplanhotel = $row["meal"];
                          ...
                          $hotel_content.="
                                    <tr style='font-size:11px;'>
                                         ...
                                         <td><input type='text' name='hotelstnd[]' value='".$row["hotelstandard"]."' size='10'></td>
                                         <td><input type='text' name='roomstnd[]' value='".$row["roomstandard"]."' size='7'></td>
...
$baggagecost = 0;
 ...
 $sql = "SELECT * FROM flights_info WHERE ghrno = '$ref_value' ORDER BY sno";
                ...
                {     
                   while($row = $res->fetch_assoc()) 
                   {      
                        if(!empty($row["airprice"]))
                          //if one then add all the prices else no need of adding
                          ...
                          $flight_content.="
                                    <tr style='font-size:11px;'>
                                            <td><select name='flighttype[]' class='flighttype'><option value='' disabled>Please select</option><option value='oneway' ".$onewaySelected.">One Way</option><option value='return' ".$returnSelected.">Return</option></select></td>
                                             ...
                                             <td><input class='pull-right' style='background: #fff; cursor: pointer;   width: 100%; margin-bottom: 10px;' type='text' name='airdates[]' size='15' value='".$row["airdates"]."'></td>

                                             <td><input type='text' name='airtrav[]' value='".$row["airtrav"]."' size='3'></td>
            ...
            <div class='col-md-9'>
                <div class ='row'>
                      <div class='form-group'>
                         ...
                         <input type='number' ng-model='num1' name='currency_amount' class='form-control' id='currencyamount' ng-init='num1=".$currency_amount."' value='".$currency_amount."' aria-label='...'  required>
                      </div>
                </div><br>
                <div class ='row'>      
                       <div class='form-group'>
                         <label for='currencyamount'>Currency value &nbsp;&nbsp;&nbsp;&nbsp;:&nbsp;&nbsp;</label>
                         <input type='number' ng-model='num2'  name='currency_value' class='form-control' id='currencyvalue' ng-init='num2=".$currency_value."' value='".$currency_value."' aria-label='...' required >
                      </div>
                </div><br>
                <div class='row'>
                  <div class='col-md-5'>
...
echo " <br>
 <fieldset class='first_set'>
            <p id='daser' class='lineheading'> Partners</p>
             <div class='col-md-9'>
                    <div class ='row'>
                      <div class='form-group'>
              ...
              <p class='lineheading'>Choose Calculation</p>
                <div class='col-md-9'>
                 ...
                 <?php echo "All Pax
                            ...
                            <div class='col-md-2'>
                              <div class='form-group' id='numOfPersons'>
                                   <label for='paxno'>Enter Number of PAX</label>
                                   <input type='text' class='form-control' placeholder='Enter Number of Pax' id='paxno' name='no_of_pax' value='".$no_of_pax."' aria-label='...'";?>
...
<!--Room type starts here-->
  ...
  <fieldset class='second_set'>
        <p class='lineheading'>Room Type</p>     
        <div class='col-md-9'>
          
          <div class ='row'>
            
            <div class="form-group">
              <label for="roomtype" style='width:300px;'>Enter Room/Sharing type &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label>
                 <?php echo "<input type='text' class='form-control' name='roomtype' size='48' value='".$roomtype."' id='roomtype' aria-label='...'><br>";?>
            </div>
          </div>
                        ...
                        <?php
                            ...
                            else
                            {
                              //ask for one way or return
                                ...
                                // echo "<div id='showflightsarea'></div> ";
...
echo "
   <fieldset class='fourth_set'>
        ...
        <div class='col-md-3' id='transportTransfers' style='border-left: 2px solid #e6e6ec;'>
              ...
              <div class='col-md-1' id='transportsicprivate' style='border-left: 2px solid #e6e6ec;'>
                <br>
                <div class='form-check'>
                  <label class='form-check-label'>";?>
...
?>        
  ...
  <center><button type="submit" name='submit_but' class="btn btn-primary savebtn">Save Changes</button></center>
  <br>
  ...
  if($ref_type=="Domestic")
    {
      ...
      $z=array("<input type='number' name='landcost' size='20' ng-model='val1'  value='".(int)$hotel_price."'  ng-init='val1=".(int)$hotel_price."'>",
                 ...
                 "<input type='number' name='flightam' size='20' value='".(int)$flight_price."' ng-init='zs=".(int)$flight_price."'>",
 ...
 else if($ref_type=="International")
    {
      ...
      $z=array(" <input type='number' name='landcost' size='20' ng-model='val1' value='".(int)$hotel_price."'  ng-init='val1=".(int)$hotel_price."'>",
                 ...
                 "<p ng-model='z6'>{{z6=(y4/100) * z2}}</p>",
                 "<p ng-model='z7'>{{z7 = z2 +z3}}</p>",
                 "<input type='number' name='flightam' size='20' ng-model='zs' value='".(int)$flight_price."' ng-init='zs=".(int)$flight_price."'>",
                 "<p ng-model='z8'>{{z8 = zs*(val4)/100 }}</p>",
...
<br>
       <div class='row'>
              ...
              <div class ='col-md-4 col-md-push-8'>
                <button type="submit" name='submit_but' class="btn btn-primary savebtn">Save</button>
                <?php echo "&nbsp;&nbsp;&nbsp;&nbsp;
